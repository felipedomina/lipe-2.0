...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Lipe\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5581982133322:+55 81 98213-3322\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["558182133322@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"558182133322@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["558182133322@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["558182133322@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558182133322@s.whatsapp.net"]
...
//msc fim
			...
			client.updatePresence(from, Presence.composing)
            tod = await getBuffer(`https://imgur.com/gallery/57542Lr`)
            client.sendMessage(from, tod, image, { quoted: mek, caption: 'O dono é esse gostoso aí😏.'})                  
	}
